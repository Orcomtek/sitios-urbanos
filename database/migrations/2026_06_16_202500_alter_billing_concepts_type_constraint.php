...
return new class extends Migration
{
    ...
    {
        DB::statement('ALTER TABLE billing_concepts DROP CONSTRAINT IF EXISTS billing_concepts_type_check');
        DB::statement("ALTER TABLE billing_concepts ADD CONSTRAINT billing_concepts_type_check CHECK (type::text = ANY (ARRAY['recurring_hoa'::character varying, 'extraordinary'::character varying, 'fine'::character varying, 'amenity_rental'::character varying, 'marketplace_subscription'::character varying, 'provider_membership'::character varying]::text[]))");
    }
};
