...
function proceedToPayment() {
    ...
    handler.open({
        ...
        currency: 'cop',
        amount: parseFloat(selectedInvoice.value.pending_amount).toFixed(2),
        tax_base: '0',
        tax: '0',
        country: 'co',
        lang: 'es',
                ...
                <div class="relative bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
                    ...
                    <div class="px-6 py-4 bg-gray-50 flex gap-3 justify-end">
                        <button
                            ...
                            class="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition"
                        >
                            Cancelar
                        </button>
                        <button
                            ...
                            class="inline-flex items-center gap-2 px-5 py-2 text-sm font-semibold text-white bg-indigo-600 border border-transparent rounded-md hover:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition"
                        >
